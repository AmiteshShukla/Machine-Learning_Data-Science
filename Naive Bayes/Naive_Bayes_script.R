...
# Problem 1B:
##Part B is same as part A with the exception that in attributes 3,4,6 & 8 we need to replace 0 with NA and check the performance with the modified dataset, same algorithm/implementation has been used as in part A
...
#Tree 10, depth 4
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 10, max_depth = 4, seed = 1234)
...
#Tree 10, depth 16
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 10, max_depth = 16, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 20, depth 4
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 20, max_depth = 4, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 20, depth 8
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 20, max_depth = 8, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 20, depth 16
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 20, max_depth = 16, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 30, depth 4
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 30, max_depth = 4, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 30, depth 8
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 30, max_depth = 8, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 30, depth 16
model <- h2o.randomForest(y=T.dep, x=T.indep, training_frame = train.h2o, ntrees = 30, max_depth = 16, seed = 1234)
preds <- as.data.frame(h2o.predict(model, newdata=test.h2o))
confusionMatrix <- table(test$class, as.vector(preds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 10, depth 8
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 10, max_depth = 8, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 10, depth 16
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 10, max_depth = 16, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 20, depth 4
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 20, max_depth = 4, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 20, depth 8
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 20, max_depth = 8, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 20, depth 16
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 20, max_depth = 16, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 30, depth 4
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 30, max_depth = 4, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 30, depth 8
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 30, max_depth = 8, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
...
#Tree 30, depth 16
newmodel <- h2o.randomForest(y=nT.dep, x=nT.indep, training_frame = newtrain.h2o, ntrees = 30, max_depth = 16, seed = 120)
newpreds <- as.data.frame(h2o.predict(newmodel, newdata=newtest.h2o))
confusionMatrix <- table(newtest$class, as.vector(newpreds$predict))
accuracy <- sum(diag(confusionMatrix))/sum(confusionMatrix)
accuracy
